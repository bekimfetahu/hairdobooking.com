    ...
    <div className="min-h-screen bg-white">
      ...
      <footer className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            {[
              ...
              <div key={column.title}>
                <h4 className="font-semibold text-sm mb-4 text-brand-black">
                  {column.title}
                </h4>
                <ul className="space-y-2">
                  {column.items.map((item) => (
                    <li key={item}>
                      <a href="#" className="text-sm text-accent hover:text-brand-black">
                        {item}
                      </a>
                    </li>
                  ))}
          ...
          {/* Bottom */}
          <div className="border-t border-gray-200 pt-8 flex justify-between items-center text-sm text-accent">
            <p>&copy; 2024 HairdoBooking. All rights reserved.</p>
