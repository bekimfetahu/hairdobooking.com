/**
 * Liked Salons Proxy (/api/liked-salons/[venueUuid])
 * Forwards like/unlike requests to `client/liked-salons/{venueUuid}`.
 */
...
export async function POST(req, { params }) {
  try {
    ...
    console.error('liked-salons proxy error', error);
