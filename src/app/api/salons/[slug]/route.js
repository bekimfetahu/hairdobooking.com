/**
 * Salon Details Proxy (/api/salons/[slug])
 * Forwards salon detail requests to Laravel without exposing backend URLs.
 */
...
export async function POST(req, { params }) {
  try {
    ...
    console.error('salon detail proxy error', error);
