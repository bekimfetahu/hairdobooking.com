    ...
    return (
        <footer className="border-t border-black/10 bg-white text-neutral-700">
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
                    ...
                    <div className="flex space-x-4">
                        <a
                            ...
                            className="text-neutral-500 transition duration-300 hover:text-black"
                        >
                ...
                {/* Bottom Section */}
                <div className="mt-8 border-t border-black/10 pt-4 text-center text-sm text-neutral-500">
