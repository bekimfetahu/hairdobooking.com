...
export default function Footer() {
    return (
        <footer className="border-t border-black/10 bg-white text-neutral-900">
            <div className="mx-auto max-w-[1200px] px-4 sm:px-6 py-8 md:py-12">
                ...
                <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <p className="mt-3 max-w-sm text-sm text-neutral-700">
                            A sleek, modern booking experience built for salons and beauty professionals.
                        </p>
                    </div>
                    ...
                    <div className="flex space-x-4">
                        <a
                            ...
                            className="text-neutral-700 transition duration-300 hover:text-black"
                        >
                ...
                {/* Bottom Section */}
                <div className="mt-8 border-t border-black/10 pt-4 text-center text-sm text-neutral-700">
                    © {new Date().getFullYear()} Hairdo Booking. All rights reserved.
                </div>
            </div>
        </footer>
    );
